        ...
        <div class="mx-auto" style="width: 800px;">
            ...
            <form @submit.prevent="submit">
                <div class="form-group">
                    ...
                    <input v-model="form.firstName" type="text" class="form-control" id="InputName" placeholder="Enter name">
                </div>
                <div class="form-group">
                    <label for="InputSurname">Surname:</label>
                    <input v-model="form.lastName" type="text" class="form-control" id="InputSurname" placeholder="Enter surname">
                </div>
                <div class="form-group">
            ...
            submit: function() {
                if (!this.form.firstName|| !this.form.lastName || !this.form.email || !this.form.password || !this.form.password2) {
                    ...
                    if (this.form.password === this.form.password2) {
                        axios.post('http://localhost:9000/service1/user/save', this.form).then((response) => {
                            this.asd = response;
                            ...
                            this.$notify({
                                ...
                                position: 'top left',
                                title: 'Hello '+response.data.firstName,
